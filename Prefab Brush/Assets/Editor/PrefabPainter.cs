 ...
 * Setup
 * --------
 * Just place this script in your Editor folder of your project similar to how it is in the demo project. You will see a new main menu item appear
 * called Prefab Brush in the Tools menu. Open that up to see the widget. 
 * 
 * All the other project files that come with the github project are for demonstration purposes only.
 * This is the only file you need to get the prefab painter to work.
 * 
 */ 
